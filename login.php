...
<section class="login py-5">
    <div class="container">
                    ...
                    <div class="col-lg-12">
                        <div class=" text-center">
                            ...
                            <div class="auth" data-event-label="google" data-social-code="google">
                                <a href="">
                                    <svg class="svg-icon google-login-icon " width="27" height="27" viewBox="0 0 27 27"
                            ...
                            <div class="auth" data-event-label="linkedin" data-social-code="linkedin">
                                <a href="">
                                    <svg class="svg-icon linkedin-login-icon " xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 32 32" width="27" height="27">
                            ...
                            <div class="forget">
                                <a href="forget.php" class="fs-6">Forget Your Password?</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
        ...
        <div class="login__block custom--login">
            <div class="site-header">
                <h3>New Customer</h3>
            ...
            <div class="col-lg-12">
                <div class=" text-center">
                    <div class="button">
                        <a href="register.php" class="btn all-button">Create an Account</a>
                    </div>
                </div>
            </div>
        </div>
